...
import Carrinho from '../../assets/icons/carrinho_preto.png';
...
const Index: React.FC = () => {
  ...
  useEffect(() => {
    async function ListAllPokemonsAPI(): Promise<void> {
      if (apiPokemons) {
        const { data } = await api.get<ResponsePokeAPI>('/type/fire/');
    ...
    <Container>
      <ModalContainer isOpen={isOpenModal}>
        ...
        <ModalContent>
          ...
          <h1>Obrigado!!!</h1>
          <img
            src="https://i.pinimg.com/originals/11/87/3e/11873ece862ba907ea1f72005c765977.gif"
            alt="pikachu_thanks"
          />
        </ModalContent>
      </ModalContainer>
